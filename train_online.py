...
if __name__ == '__main__':
    ...
    if args.resume_last or args.resume_best:
        if args.resume_last:
            fname = Path('/home/ayousefi/projects/def-kpassi/ayousefi/Epoch0_Grounded_Shuffled_Clip').joinpath(f'{args.exp_name}_last_emo.pth')
        ...
        fname = Path('/home/ayousefi/projects/def-kpassi/ayousefi/Epoch9_Grounded_Shuffled_Clip').joinpath(f'{best_xe_model}_last_emo.pth')
    ...
    for e in range(start_epoch, start_epoch + 100):
        ...
        if args.rank == 0:
            ...
            if args.use_emotion_labels:
                torch.save(save_dict, f'/home/ayousefi/projects/def-kpassi/ayousefi/Epoch0_Grounded_Shuffled_Clip/{args.exp_name}_last_emo.pth')
            else:
                torch.save(save_dict, f'/home/ayousefi/projects/def-kpassi/ayousefi/Epoch0_Grounded_Shuffled_Clip/{args.exp_name}_last_emo.pth')

            if best:
                if args.use_emotion_labels:
                    copyfile(f'/home/ayousefi/projects/def-kpassi/ayousefi/Epoch0_Grounded_Shuffled_Clip/{args.exp_name}_last_emo.pth', f'/home/ayousefi/projects/def-kpassi/ayousefi/Epoch0_Grounded_Shuffled_Clip/{args.exp_name}_best_emo.pth')
                else:
                    copyfile(f'/home/ayousefi/projects/def-kpassi/ayousefi/Epoch0_Grounded_Shuffled_Clip/{args.exp_name}_last_emo.pth', f'/home/ayousefi/outputs/camel/saved_models/{args.exp_name}_best_emo.pth')
